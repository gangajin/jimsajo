...
<ul>
  <li><b>여행 패키지 조회</b>
    <ul>
      <li>다양한 여행지와 테마의 패키지를 카드 형태로 탐색 가능</li>
    </ul>
  </li>
  <li><b>패키지 상세 정보 확인</b>
    <ul>
      <li>일정표, 숙소, 포함사항 등 상세한 여행 정보 제공</li>
    </ul>
  </li>
  <li><b>예약 기능</b>
    <ul>
      <li>출발일, 인원수, 예약자 정보를 입력해 예약 요청 가능</li>
    </ul>
  </li>
  <li><b>실시간 결제 기능</b>
    <ul>
      <li>외부 결제 API와 연동하여 결제 처리</li>
    </ul>
  </li>
  <li><b>회원가입 / 로그인 / 로그아웃</b>
    <ul>
      <li>사용자 인증을 통한 개인 정보 보호</li>
    </ul>
  </li>
  <li><b>마이페이지</b>
     <ul>
       <li>내 예약 내역 확인, 취소 요청 등 개인 맞춤 기능 제공</li>
     </ul>
   </li>
   <li><b>문의 작성 및 확인</b>
     <ul>
       <li>1:1 문의 및 관리자 답변 확인</li>
     </ul>
   </li>
</ul>
...
<ul>
  <li><b>패키지 상품 관리</b>
    <ul>
      <li>패키지 등록, 수정,추천, 삭제 기능</li>
    </ul>
  </li>
  <li><b>문의 답변 등록</b>
    <ul>
      <li>사용자 문의 내역 확인 및 답변 등록</li>
    </ul>
  </li>

  <li><b>전체 주문내역 확인</b>
    <ul>
      <li>사용자가 주문한 모든 내역을 확인하여 문의가 생기면 </li>
    </ul>
  </li>

  <li><b>공지사항 작성</b>
    <ul>
      <li>사용자가 볼 수 있는 공지사항을 작성할 수 있습니다. </li>
    </ul>
  </li>
</ul>
